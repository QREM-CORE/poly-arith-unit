...
module tf_rom (
    ...
    localparam r4_rom_t R4NTT_ROM = '{
        {12'd2580, 12'd1729, 12'd3289},  // [ 0] Pass 1
        {12'd1062, 12'd2642, 12'd2786},  // [ 1] Pass 2
        {12'd193,  12'd630,  12'd1746},  // [ 2]
        {12'd2786, 12'd1897, 12'd1919},  // [ 3]
        {12'd569,  12'd848,  12'd3136},  // [ 4]
        {12'd289,  12'd296,  12'd2319},  // [ 5] Pass 3
        {12'd3253, 12'd2447, 12'd452},   // [ 6]
        {12'd1197, 12'd1339, 12'd1534},  // [ 7]
        {12'd2277, 12'd1476, 12'd1891},  // [ 8]
        {12'd650,  12'd3046, 12'd2474},  // [ 9]
        {12'd2513, 12'd56,   12'd910},   // [10]
        {12'd2865, 12'd2240, 12'd2617},  // [11]
        {12'd1320, 12'd1333, 12'd1848},  // [12]
        {12'd2319, 12'd1426, 12'd1197},  // [13]
        {12'd807,  12'd2094, 12'd2055},  // [14]
        {12'd1438, 12'd535,  12'd331},   // [15]
        {12'd1534, 12'd2882, 12'd76},    // [16]
        {12'd2647, 12'd2393, 12'd2513},  // [17]
        {12'd1481, 12'd2879, 12'd2679},  // [18]
        {12'd2474, 12'd1974, 12'd33},    // [19]
        {12'd1227, 12'd821,  12'd2009}   // [20]
    };
    ...
    localparam r4_rom_t R4INTT_ROM = '{
        {12'd2190, 12'd1254, 12'd2999},  // [ 0] INTT Pass 1
        {12'd1046, 12'd2342, 12'd2505},  // [ 1]
        {12'd462,  12'd225,  12'd1502},  // [ 2]
        {12'd1835, 12'd468,  12'd3125},  // [ 3]
        {12'd1281, 12'd1888, 12'd19},    // [ 4]
        {12'd1305, 12'd1397, 12'd915},   // [ 5]
        {12'd2295, 12'd2282, 12'd1346},  // [ 6]
        {12'd1917, 12'd2616, 12'd2796},  // [ 7]
        {12'd2999, 12'd998,  12'd462},   // [ 8]
        {12'd116,  12'd2209, 12'd3151},  // [ 9]
        {12'd204,  12'd3301, 12'd1892},  // [10]
        {12'd1502, 12'd1806, 12'd2283},  // [11]
        {12'd263,  12'd2591, 12'd1305},  // [12]
        {12'd533,  12'd995,  12'd2048},  // [13]
        {12'd19,   12'd441,  12'd113},   // [14]
        {12'd760,  12'd3181, 12'd1412},  // [15]
        {12'd690,  12'd2905, 12'd784},   // [16] INTT Pass 2
        {12'd968,  12'd716,  12'd1312},  // [17]
        {12'd784,  12'd3014, 12'd2101},  // [18]
        {12'd1399, 12'd2008, 12'd2361},  // [19]
        {12'd2684, 12'd800,  12'd3319}   // [20] INTT Pass 3
    };
    ...
    localparam r2_rom_t OMEGA_INV_ROM = '{
        12'd2252, 12'd1222, 12'd197,  12'd2274, 12'd1150, 12'd2392, 12'd2723, 12'd2468,
        12'd2886, 12'd277,  12'd2254, 12'd1093, 12'd2816, 12'd1463, 12'd2783, 12'd1927,
        12'd2032, 12'd2096, 12'd1384, 12'd615,  12'd1286, 12'd278,  12'd1505, 12'd1133,
        12'd842,  12'd2284, 12'd390,  12'd1477, 12'd1719, 12'd646,  12'd2180, 12'd2537,
        12'd1344, 12'd3195, 12'd496,  12'd1298, 12'd2135, 12'd446,  12'd2175, 12'd1195,
        12'd321,  12'd934,  12'd2853, 12'd741,  12'd770,  12'd270,  12'd839,  12'd813,
        12'd1804, 12'd157,  12'd2251, 12'd2951, 12'd1548, 12'd24,   12'd1998, 12'd960,
        12'd2779, 12'd2185, 12'd1303, 12'd846,  12'd340,  12'd1373, 12'd284,  12'd1656
    };
